...
key | description  
:--- | :---  
**username (Required)** | the username, you registered with on livegpstracks
**client_id (Required)** | the ID of your livegpstracks share
**scan_interval (Option)** | update interval, default 120 sec
